...
from ABSingleLick import ABSingleLick
import json
import sys
import threading
import Utilities
...
class ABSingleLickGui:
    def __init__(self,root=Tk()):
        ...
        self.titleLabel = Label(self.root,text='AppleBanana Single Lick Experiment',font=STATUS_FONT,bg=BACKGROUND_COLOR)
        self.ard = None
        ...
        #ardInitFrame
        self.ardInitFrameLabel = Label(self.ardInitFrame,text="Connect to Hardware",bg=HEADER_COLOR,font=LARGE_FONT,fg='white',relief='solid',borderwidth=2,width=40)
        ...
        #ardControlFrame
        self.ardControlFrameLabel = Label(self.ardControlFrame,text='Pre-experiment Control',bg=HEADER_COLOR,font=LARGE_FONT,fg='white',relief='solid',borderwidth=2,width=40)
        ...
        #initFrame
        self.initFrameLabel = Label(self.initFrame,text="Session Configuration",font=LARGE_FONT,bg=HEADER_COLOR,fg='white',relief='solid',borderwidth=2,width=40)
        ...
        #finalControlFrame
        self.finalControlFrameLabel = Label(self.finalControlFrame,text='Experiment Control',bg=HEADER_COLOR,font=LARGE_FONT,fg='white',relief='solid',bd=2,width=40)
    ...
    def selectFile(self,event=None):
        ...
        for widget in self.argFrame.winfo_children():
            widget.destroy()
        self.argFrameLabel = Label(self.argFrame,text="Experiment Configuration: "+os.path.basename(fileName),font=LARGE_FONT,bg=HEADER_COLOR,fg='white',relief='solid',bd=2,width=40).grid(columnspan=2,padx=40,pady=10)
        try:
        ...
        self.trialDuration = correctTrialDuration*self.args["A image probability"] + wrongTrialDuration*(1-self.args["A image probability"])
